...
//        rectangle( res, Point( rect.x, rect.y ), Point(rect.x + rect.width, rect.y + rect.height ), GREEN, 2);
  ...
  imshow(*winName1, res);
  imwrite("/home/j11218gpu/ljy_projects/paper/imag/grabcut.jpg", res);
}
...
//  rect.x = max(0, rect.x);//256, 144
//  rect.y = max(0, rect.y);
//  rect.width = min(rect.width, image->cols - rect.x);//819 x 451
...
int main(int argc, char **argv) {
  ...
  string filename = "/home/j11218gpu/ljy_projects/paper/imag/reslic2.jpg";
  Mat image = imread(filename, 1);
  Mat image1 = imread("/home/j11218gpu/ljy_projects/paper/imag/img2.jpg", 1);
  ...
  for (;;) {
    ...
    switch ((char) c) {
      ...
      case 'r':cout << endl;
        ...
        gcapp.showImage1();
        break;
      case 'n':gettimeofday(&start, NULL);
