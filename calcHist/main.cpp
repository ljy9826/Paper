...
int main()
{
    ...
    string source_src = "/home/j11218gpu/ljy_projects/paper/image/1";
    ...
    /// color image intensity equalization
    {
        ...
        //resize(intensity_color_dst,intensity_color_dst,Size(512,512));
        imwrite(source_src+"intensity_color.jpg",intensity_color_dst);
    }
    ...
    /// color image each channel equalization
    {
        ...
        //resize(channel_color_dst,channel_color_dst,Size(512,512));
        imwrite(source_src+"channel_color.jpg",channel_color_dst);
    }
