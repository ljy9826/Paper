...
public:
    ...
    void setImageAndWinName1( const Mat& _image, const string& _winName );
    void showImage() const;
    void showImage1() const;
...
/*给类的成员变量赋值而已*/
void GCApplication::setImageAndWinName1( const Mat& _image, const string& _winName  )
{
    if( _image.empty() || _winName.empty() )
        return;
    image1 = &_image;
...
void GCApplication::showImage() const
{
    ...
    imshow( *winName, res );
    //imwrite("/home/j11218gpu/ljy_projects/img/1.jpg", res);
}

void GCApplication::showImage1() const
{
    if( image1->empty() || winName1->empty() )
        return;
    ...
    {
        getBinMask( mask, binMask );
        image1->copyTo( res, binMask );  //按照最低位是0还是1来复制，只保留跟前景有关的图像，比如说可能的前景，可能的背景
    }
...
//        rectangle( res, Point( rect.x, rect.y ), Point(rect.x + rect.width, rect.y + rect.height ), GREEN, 2);
    ...
    imshow( *winName1, res );
    imwrite("/home/j11218gpu/ljy_projects/paper/image/grabcut.jpg", res);
}
...
int main( int argc, char** argv )
{
    ...
    //string filename = "/home/j11218gpu/ljy_projects/paper/image/0.jpg";
    //string filename = "/home/j11218gpu/ljy_projects/paper/image/6.png";
    string filename = "/home/j11218gpu/ljy_projects/paper/slic/lenna_M5_K500_loop9.png";
    Mat image = imread( filename, 1 );
    Mat image1 = imread( "/home/j11218gpu/ljy_projects/paper/image/6.png", 1 );
...
//
//    //滤波(降噪)
//    blur(gray, canny_out, Size(5, 5));
//
//    //GaussianBlur(gray,canny_out,Size(5,5),0,0);
//
//    Canny(canny_out, canny_out, 10, 30);
//    imshow("canny", canny_out );
    ...
    const string winName1 = "image1";
    cvNamedWindow( winName1.c_str(), CV_WINDOW_AUTOSIZE );

    cvSetMouseCallback( winName.c_str(), on_mouse, 0 );

    gcapp.setImageAndWinName( image, winName );
    gcapp.setImageAndWinName1( image1, winName1 );
    gcapp.showImage();
    gcapp.showImage1();
